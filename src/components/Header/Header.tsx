...
export const Header = ({ toggleNavigation }: HeaderProps) => {
	...
	return (
		<>
			<AppBar position='fixed' sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, paddingLeft: '100px', paddingRight: '100px' }}>
				<Toolbar disableGutters variant='dense'>
					...
					<Box sx={{ display: { xs: 'none', md: 'flex', alignItems: 'center' } }}>
						<IOSSwitch />
						<Button variant="contained" style={{ marginLeft: '10px', marginRight: '10px' }}>I am a photographer</Button>
						<Button variant="contained">I am a partner</Button>
						<ThemeSwitcher />
						{/* <Messages total={15} />
